% Loading  Cryotherapy data set
%
load cryotherapy.csv
%
...
%Nonlinear SVMs
%
nonlinear_model = nonlinearclassifier(best_X_train, y_train,10,1);
%
...
legend([scatter;hyperplane_support_vectors],{'Age','Time','support vectors'})
